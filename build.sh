...
# CLEAN UP 
#cd 6300-Project; for i in $(find  ./ -name .DS_Store); do rm $i; done; cd "$dir1"

# SET CORRECT PERMISSIONS FOR ALL FILES 
for i in $(find 6300-Project -type f); do chmod 644 $i; done
for i in $(find 6300-Project -type d); do chmod 755 $i; done
...
if [[ "$OSTYPE" == "darwin"* ]]; then
    ...
    find 6300-Project -name ".DS_Store" -delete
...
if [[ "$choice" == [Yy]* ]]; then
    ...
    #rsync -avz --delete 6300-Project/ mt1584@georgetown.edu:/path/to/your/domains/folder
    scp -r 6300-Project htrangeo@htran.georgetown.domains:/home/htrangeo/public_html/
